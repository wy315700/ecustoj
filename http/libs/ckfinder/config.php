...
*/
$baseUrl = '/onlinejudge/resource/';
$ojRootURL = '/onlinejudge/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'doc,docx,docm,dotx,dot,dotm,pdf,xps,mht,mhtml,htm,html,rtf,txt,xml,odt,wtf,odt',
		'deniedExtensions' => '');
/*
